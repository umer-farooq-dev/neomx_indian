...
@section('panel')
        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.report.transaction',$user->id) }}?wallet_type=main"
                        title="Main Wallet"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.report.transaction',$user->id) }}?wallet_type=referral"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.report.transaction',$user->id) }}?wallet_type=reward"
                        title="Reward Wallet"
                        icon="las la-gift"
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <button data-bs-toggle="modal" data-bs-target="#grantSpinModal" class="btn btn--primary btn--shadow w-100 btn-lg">
                        <i class="las la-dharmachakra"></i> @lang('Grant Spins')
                    </button>
                </div>
    ...
    {{-- Grant Spins MODAL --}}
    <div id="grantSpinModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Grant Spins to') {{ $user->username }}</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                <form action="{{ route('admin.users.grant.spins', $user->id) }}" class="disableSubmission" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label>@lang('Number of Spins')</label>
                            <input type="number" name="count" min="1" class="form-control" value="1" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary h-45 w-100">@lang('Grant')</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="wallet_type" class="form-control select2" data-minimum-results-for-search="-1" required>
                                <option value="main">@lang('Main Wallet')</option>
                                <option value="referral">@lang('Referral Wallet')</option>
                                <option value="reward">@lang('Reward Wallet')</option>
                            </select>
                        </div>
                        <div class="form-group">
