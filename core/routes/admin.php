...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::post('grant-spins/{id}', 'grantSpins')->name('grant.spins');
    ...
    // Spin & Reward
    Route::controller('SpinController')->name('spin.')->prefix('spin')->group(function () {
        Route::get('rewards', 'rewards')->name('rewards');
        Route::post('rewards/store/{id?}', 'rewardStore')->name('rewards.store');
        Route::post('rewards/status/{id}', 'rewardStatus')->name('rewards.status');
        Route::post('rewards/delete/{id}', 'rewardDelete')->name('rewards.delete');

        Route::get('rules', 'rules')->name('rules');
        Route::post('rules/store/{id?}', 'ruleStore')->name('rules.store');
        Route::post('rules/status/{id}', 'ruleStatus')->name('rules.status');
        Route::post('rules/delete/{id}', 'ruleDelete')->name('rules.delete');
    });
    ...
    Route::controller('ReferralController')->name('referral.')->prefix('referral')->group(function () {
        ...
        Route::post('levels/store/{id?}', 'levelStore')->name('levels.store');
        Route::post('levels/status/{id}', 'levelStatus')->name('levels.status');
        Route::post('levels/delete/{id}', 'levelDelete')->name('levels.delete');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        //Site Notice
        Route::get('notice', 'notice')->name('setting.notice');
        Route::post('notice', 'noticeSubmit')->name('setting.notice.submit');
